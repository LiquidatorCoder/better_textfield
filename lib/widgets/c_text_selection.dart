...
import 'package:better_textfield/widgets/b_text_selection.dart'
    as b_text_selection;
...
class _CupertinoTextSelectionControlsToolbar extends StatefulWidget {
  ...
  final b_text_selection.ClipboardStatusNotifier? clipboardStatus;
...
class _CupertinoTextSelectionControlsToolbarState extends State<_CupertinoTextSelectionControlsToolbar> {
  b_text_selection.ClipboardStatusNotifier? _clipboardStatus;
  ...
  void initState() {
    ...
    if (widget.handlePaste != null) {
      _clipboardStatus = widget.clipboardStatus ?? b_text_selection.ClipboardStatusNotifier();
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.handlePaste != null
        && _clipboardStatus!.value == b_text_selection.ClipboardStatus.unknown) {
    ...
    if (widget.handlePaste != null
        && _clipboardStatus!.value == b_text_selection.ClipboardStatus.pasteable) {
...
class CupertinoTextSelectionControls extends b_text_selection.TextSelectionControls {
  ...
  Widget buildToolbar(
    ...
    b_text_selection.TextSelectionDelegate delegate,
    b_text_selection.ClipboardStatusNotifier clipboardStatus,
  ...
  @override
  Widget buildHandle(BuildContext context, b_text_selection.TextSelectionHandleType type, double textLineHeight, [VoidCallback? onTap, double? startGlyphHeight, double? endGlyphHeight]) {
    ...
    switch (type) {
      case b_text_selection.TextSelectionHandleType.left:
        ...
        return handle;
      case b_text_selection.TextSelectionHandleType.right:
      ...
      case b_text_selection.TextSelectionHandleType.collapsed:
  ...
  @override
  Offset getHandleAnchor(b_text_selection.TextSelectionHandleType type, double textLineHeight, [double? startGlyphHeight, double? endGlyphHeight]) {
    startGlyphHeight = startGlyphHeight ?? textLineHeight;
    endGlyphHeight = endGlyphHeight ?? textLineHeight;
...
final b_text_selection.TextSelectionControls cupertinoTextSelectionControls = CupertinoTextSelectionControls();
