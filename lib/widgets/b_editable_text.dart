...
class EditableText extends StatefulWidget {
  ...
  /// {@endtemplate}
  final b_text_selection.TextSelectionControls? selectionControls;
...
class EditableTextState extends State<EditableText>
  ...
  late final AnimationController _cursorBlinkOpacityController =
      AnimationController(
    vsync: this,
    ...
    if (widget.selectionControls == null) {
      ...
      if (_selectionOverlay == null) {
        _selectionOverlay = TextSelectionOverlay(
          ...
          selectionControls: widget.selectionControls as TextSelectionControls,
  ...
  Widget build(BuildContext context) {
    ...
    final b_text_selection.TextSelectionControls? controls =
