...
class _DesktopTextSelectionControls
...
final b_text_selection.TextSelectionControls desktopTextSelectionControls =
...
class _DesktopTextSelectionControlsToolbarState
  ...
  void initState() {
    ...
    if (widget.handlePaste != null) {
      _clipboardStatus =
          widget.clipboardStatus ?? b_text_selection.ClipboardStatusNotifier();
...
class _DesktopTextSelectionToolbar extends StatelessWidget {
  ...
  /// default toolbar.
  final b_text_selection.ToolbarBuilder toolbarBuilder;
